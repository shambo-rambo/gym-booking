...
>(({ side = "left", className, children, ...props }, ref) => {
  ...
  const positionClass = {
    ...
    top: "inset-x-0 top-0 w-full max-h-[75vh] border-b",
    bottom: "inset-x-0 bottom-0 w-full max-h-[90vh] border-t rounded-t-2xl"
  }
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 bg-background p-6 shadow-lg transition-transform duration-300 ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out",
          positionClass[side],
          slideInClass[side],
          className
        )}
