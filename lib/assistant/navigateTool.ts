...
export const PAGE_HOWTO: Record<string, string> = {
  ...
  "/settings/notifications": "Tap your profile icon (top right), then Notifications, to choose which categories of message you receive and how (email or text).",
